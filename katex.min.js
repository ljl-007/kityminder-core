!function(t, e) {
  ...
  , function(t, e, r) {
      ...
      $("text", Z, "textord", "\u201c", "\u201c"),
      $("text", Z, "textord", "\u201d", "\u201d");
      var xt = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathdefault", "textit", "Math-Italic"], ["mathdefault", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]]
      ...
      var St = kt
        ...
        , Dt = {
          ...
          mathsym: function(t, e, r, a) {
              return void 0 === a && (a = []),
              "boldsymbol" === r.font && Ct(t, "Main-Bold", e).metrics ? qt(t, "Main-Bold", e, r, a.concat(["mathbf"])) : "\\" === t || "main" === j[e][t].font ? qt(t, "Main-Regular", e, r, a) : qt(t, "AMS-Regular", e, r, a.concat(["amsrm"]))
          },
          makeSpan: Rt,
          makeSvgSpan: Ot,
          ...
          makeOrd: function(t, e, r) {
              var a, n = t.mode, i = t.text, s = ["mord"], h = "math" === n || "text" === n && e.font, l = h ? e.font : e.fontFamily;
              ...
              if (l) {
                  ...
                  if ("boldsymbol" === l || "mathnormal" === l) {
                      ...
                      c.contains(Bt, i) ? (d = "Main-Italic",
                      f = ["mathit"]) : h ? (d = Ht[l].fontName,
                      f = [l]) : (d = Lt(l, e.fontWeight, e.fontShape),
                      f = [l, e.fontWeight, e.fontShape]);
                  if (Ct(i, d, n).metrics)
                      return qt(i, d, n, e, s.concat(f));
          ...
          tryCombineChars: function(t) {
              for (var e = 0; e < t.length - 1; e++) {
                  var r = t[e]
                    , a = t[e + 1];
                  r instanceof E && a instanceof E && Nt(r, a) && (r.text += a.text,
      ...
      function Ut(t, e) {
          ...
          if (!r)
              throw new Error('Expected node of type "atom" and family "' + e + '", but got ' + (t ? "atom" === t.type ? "atom of family " + t.family : "node of type " + t.type : String(t)));
          return r
      }
      function Gt(t) {
          var e = Yt(t);
        ...
        , he = function t(e, r, a, n) {
          ...
          for (var i = 0; i < e.length; i++) {
              ...
              if (s)
                  ...
                  var h = r(o, a.node);
                  h && (a.insertAfter ? a.insertAfter(h) : (e.unshift(h),
                  i++)),
                  a.node = o,
      ...
      function de(t, e) {
          ...
          for (var a, n = se(t, e, !0), i = [], o = [], s = 0; s < n.length; s++)
              ...
              n[s].hasClass("mbin") || n[s].hasClass("mrel") || n[s].hasClass("allowbreak")) {
                  for (var h = !1; s < n.length - 1 && n[s + 1].hasClass("mspace") && !n[s + 1].hasClass("newline"); )
                      s++,
                      o.push(n[s]),
                      n[s].hasClass("nobreak") && (h = !0);
                  h || (i.push(pe(o, e)),
                  o = [])
              } else
      ...
      var ge = function() {
        ...
        , ke = function(t, e, r) {
          if (1 === t.length) {
              var a = Me(t[0], e);
              return r && a instanceof ge && "mo" === a.type && (a.setAttribute("lspace", "0em"),
              ...
              if (s instanceof ge && n instanceof ge) {
                  ...
                  if ("mi" === s.type && 1 === s.children.length && "mn" === n.type) {
                      ...
                      if (u instanceof xe && "\u0338" === u.text && ("mo" === s.type || "mi" === s.type || "mn" === s.type)) {
                          var p = s.children[0];
                          p instanceof xe && p.text.length > 0 && (p.text = p.text.slice(0, 1) + "\u0338" + p.text.slice(1),
                          i.pop())
                      }
                  }
              }
      ...
      var Ae = function(t) {
        ...
        , Oe = function(t, e) {
          var r = function() {
              ...
              var u, p, d = [], f = qe[a], g = f[0], x = f[1], v = f[2], b = v / 1e3, y = g.length;
              if (1 === y)
                  u = ["hide-tail"],
                  p = [f[3]];
              else if (2 === y)
        ...
        , Ee = function(t, e) {
          ...
          if (a.isStretchy)
              ...
              var u, p;
              "\\vec" === a.label ? (u = Dt.staticSvg("vec", e),
              p = Dt.svgData.vec[1]) : ((u = D(u = Dt.makeOrd({
                  mode: a.mode,
                  text: a.label
              }, e, "textord"))).italic = 0,
              p = u.width),
      ...
      Qt({
          ...
          htmlBuilder: function(t, e) {
              var r, a = e.style, n = e.havingStyle(a.sup()), i = Dt.wrapFragment(ue(t.body, n, e), e);
              i.classes.push("x-arrow-pad"),
              t.below && (n = e.havingStyle(a.sub()),
              (r = Dt.wrapFragment(ue(t.below, n, e), e)).classes.push("x-arrow-pad"));
              var o, s = Oe(t, e), h = -e.fontMetrics().axisHeight + .5 * s.height, l = -e.fontMetrics().axisHeight - .5 * s.height - .111;
              if ((i.depth > .25 || "\\xleftequilibrium" === t.label) && (l -= i.depth),
              r) {
          ...
          mathmlBuilder: function(t, e) {
              ...
              if (t.body) {
                  ...
                  if (t.below) {
                      ...
                      r = new ve.MathNode("mover",[a, n])
              } else if (t.below) {
                  var o = Pe(Me(t.below, e));
                  r = new ve.MathNode("munder",[a, o])
              } else
                  r = Pe(),
                  r = new ve.MathNode("mover",[a, r]);
              return r
          }
      }),
      Qt({
      ...
      var Ve = function(t, e, r) {
        ...
        , _e = function(t, e, r, a, n, i) {
          ...
          s = null;
          var m = "Size1-Regular";
          "\\uparrow" === t ? h = l = "\u23d0" : "\\Uparrow" === t ? h = l = "\u2016" : "\\downarrow" === t ? o = h = "\u23d0" : "\\Downarrow" === t ? o = h = "\u2016" : "\\updownarrow" === t ? (o = "\\uparrow",
          h = "\u23d0",
          l = "\\downarrow") : "\\Updownarrow" === t ? (o = "\\Uparrow",
          h = "\u2016",
          l = "\\Downarrow") : "[" === t || "\\lbrack" === t ? (o = "\u23a1",
          h = "\u23a2",
          l = "\u23a3",
          m = "Size4-Regular") : "]" === t || "\\rbrack" === t ? (o = "\u23a4",
          h = "\u23a5",
          l = "\u23a6",
          m = "Size4-Regular") : "\\lfloor" === t || "\u230a" === t ? (h = o = "\u23a2",
          l = "\u23a3",
          m = "Size4-Regular") : "\\lceil" === t || "\u2308" === t ? (o = "\u23a1",
          h = l = "\u23a2",
          m = "Size4-Regular") : "\\rfloor" === t || "\u230b" === t ? (h = o = "\u23a5",
          l = "\u23a6",
        ...
        , ir = function(t, e) {
          var r, a, n = e.havingBaseSizing(), i = ar("\\surd", t * n.sizeMultiplier, er, n), o = n.sizeMultiplier, s = Math.max(0, e.minRuleThickness - e.fontMetrics().sqrtRuleThickness), h = 0, l = 0, m = 0;
          return "small" === i.type ? (t < 1 ? o = 1 : t < 1.4 && (o = .7),
          l = (1 + s) / o,
          (r = je("sqrtMain", h = (1 + s + .08) / o, m = 1e3 + 1e3 * s + 80, s, e)).style.minWidth = "0.853em",
          a = .833 / o) : "large" === i.type ? (m = 1080 * Je[i.size],
          l = (Je[i.size] + s) / o,
          h = (Je[i.size] + s + .08) / o,
          (r = je("sqrtSize" + i.size, h, m, s, e)).style.minWidth = "1.02em",
          a = 1 / o) : (h = t + s + .08,
          l = t + s,
      ...
      Qt({
          ...
          htmlBuilder: function(t, e) {
              ur(t);
              for (var r, a, n = se(t.body, e, !0, ["mopen", "mclose"]), i = 0, o = 0, s = !1, h = 0; h < n.length; h++)
                  n[h].isMiddle ? s = !0 : (i = Math.max(n[h].height, i),
                  o = Math.max(n[h].depth, o));
              if (i *= e.sizeMultiplier,
              o *= e.sizeMultiplier,
              r = "." === t.left ? ce(e, ["mopen"]) : hr(t.left, i, o, e, t.mode, ["mopen"]),
              n.unshift(r),
              s)
      ...
      var pr = function(t, e) {
          var r, a, n = Dt.wrapFragment(ue(t.body, e), e), i = t.label.substr(1), o = e.sizeMultiplier, s = 0, h = c.isCharacterBox(t.body);
          if ("sout" === i)
              ...
              l = e.fontMetrics().fboxsep + ("colorbox" === i ? 0 : m)) : l = h ? .2 : 0,
              r = Ie(n, i, l, e),
      ...
      var yr = function(t, e) {
          var r, a, n = t.body.length, i = t.hLinesBeforeRow, s = 0, h = new Array(n), l = [], m = Math.max(e.fontMetrics().arrayRuleWidth, e.minRuleThickness), u = 1 / e.fontMetrics().ptPerEm, p = 5 * u;
          ...
          var C, q, N = b / 2 + e.fontMetrics().axisHeight, I = t.cols || [], R = [];
          for (a = 0,
          ...
          ++q) {
              ...
              if (!(a >= s)) {
                  var P = void 0;
                  (a > 0 || t.hskipBeforeAndAfter) && 0 !== (P = c.deflt(O.pregap, p)) && ((C = Dt.makeSpan(["arraycolsep"], [])).style.width = P + "em",
                  R.push(C));
                  var D = [];
                  for (r = 0; r < n; ++r) {
                      var F = h[r]
                  ...
                  R.push(D),
                  (a < s - 1 || t.hskipBeforeAndAfter) && 0 !== (P = c.deflt(O.postgap, p)) && ((C = Dt.makeSpan(["arraycolsep"], [])).style.width = P + "em",
                  R.push(C))
              }
          }
          if (h = Dt.makeSpan(["mtable"], R),
          l.length > 0) {
        ...
        , kr = function(t, e) {
          ...
          if (t.cols) {
              ...
              for (var c = l; c < m; c++)
                  ...
                  h && (s += "none "),
                  h = !0) : "separator" === o[c].type && h && (s += "|" === o[c].separator ? "solid " : "dashed ",
                  h = !1);
        ...
        , Sr = function(t, e) {
          ...
          return n.colSeparationType = c ? "align" : "alignat",
          n
      };
      gr({
          type: "array",
      ...
      function Tr(t, e) {
          var r, a = ke(t.body, e);
          return "minner" === t.mclass ? ve.newDocumentFragment(a) : ("mord" === t.mclass ? t.isCharacterBox ? (r = a[0]).type = "mi" : r = new ve.MathNode("mi",a) : (t.isCharacterBox ? (r = a[0]).type = "mo" : r = new ve.MathNode("mo",a),
      ...
      var Ir = function(t, e) {
        ...
        , Rr = function(t, e) {
          ...
          l = Dt.makeLineSpan("frac-line", e, m)) : l = Dt.makeLineSpan("frac-line", e),
          m = l.height,
          c = l.height) : (l = null,
          m = 0,
      ...
      Qt({
          ...
          handler: function(t, e) {
              var r, a = t.parser, n = t.funcName, i = e[0], o = e[1], s = null, h = null, l = "auto";
              switch (n) {
              case "\\cfrac":
              case "\\dfrac":
              case "\\frac":
      ...
      Qt({
          ...
          handler: function(t, e) {
              ...
              var o = i ? Lr(i.text) : null
                , s = Vt(e[1], "atom");
              s && (s = Ut(e[1], "close"));
              var h, l = s ? Lr(s.text) : null, m = Ft(e[2], "size"), c = null;
      ...
      var Hr = function(t, e) {
          var r, a, n = e.style, i = Vt(t, "supsub");
          i ? (r = i.sup ? ue(i.sup, e.havingStyle(n.sup()), e) : ue(i.sub, e.havingStyle(n.sub()), e),
          a = Ft(i.base, "horizBrace")) : a = Ft(t, "horizBrace");
          var o, s = ue(a.base, e.havingBaseStyle(w.DISPLAY)), h = Oe(a, e);
      ...
      Qt({
          ...
          mathmlBuilder: function(t, e) {
              var r = Se(t.body, e);
              return r instanceof ge || (r = new ge("mrow",[r])),
      ...
      Qt({
          ...
          handler: function(t, e, r) {
              ...
              return "" === h && (h = (h = (h = p).replace(/^.*[\\\/]/, "")).substring(0, h.lastIndexOf("."))),
      ...
      Qt({
          ...
          htmlBuilder: function(t, e) {
              var r;
              "clap" === t.alignment ? (r = Dt.makeSpan([], [ue(t.body, e)]),
              r = Dt.makeSpan(["inner"], [r], e)) : r = Dt.makeSpan(["inner"], [ue(t.body, e)]);
      ...
      var Fr = function(t, e, r, a, n, i, o) {
        ...
        , Vr = ["\\smallint"]
        , Ur = function(t, e) {
          var r, a, n, i = !1, o = Vt(t, "supsub");
          o ? (r = o.sup,
          a = o.sub,
          n = Ft(o.base, "op"),
          i = !0) : n = Ft(t, "op");
          var s, h = e.style, l = !1;
          if (h.size === w.DISPLAY.size && n.symbol && !c.contains(Vr, n.name) && (l = !0),
          n.symbol) {
              var m = l ? "Size2-Regular" : "Size1-Regular"
                , u = "";
              if ("\\oiint" !== n.name && "\\oiiint" !== n.name || (u = n.name.substr(1),
          ...
          var v = 0
            , b = 0;
          return (s instanceof E || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (v = (s.height - s.depth) / 2 - e.fontMetrics().axisHeight,
          b = s.italic),
          i ? Fr(s, r, a, e, h, b, v) : (v && (s.style.position = "relative",
          s.style.top = v + "em"),
          s)
      }
        , Gr = function(t, e) {
      ...
      var Xr = function(t, e) {
          var r, a, n, i, o = !1, s = Vt(t, "supsub");
          if (s ? (r = s.sup,
          a = s.sub,
          n = Ft(s.base, "operatorname"),
          o = !0) : n = Ft(t, "operatorname"),
          n.body.length > 0) {
      ...
      te({
          ...
          htmlBuilder: function(t, e) {
              ...
              if (r)
                  return r(t, e);
              var a, n, i, o = t.base, s = t.sup, h = t.sub, l = ue(o, e), m = e.fontMetrics(), u = 0, p = 0, d = o && c.isCharacterBox(o);
              if (s) {
                  var f = e.havingStyle(e.style.sup());
                  a = ue(s, f, e),
                  d || (u = l.height - f.fontMetrics().supDrop * f.sizeMultiplier / e.sizeMultiplier)
              }
              if (h) {
                  var g = e.havingStyle(e.style.sub());
                  n = ue(h, g, e),
                  d || (p = l.depth + g.fontMetrics().subDrop * g.sizeMultiplier / e.sizeMultiplier)
              }
          ...
          mathmlBuilder: function(t, e) {
              var r, a = !1, n = Vt(t.base, "horizBrace");
              n && !!t.sup === n.isOver && (a = !0,
              r = n.isOver),
              !t.base || "op" !== t.base.type && "operatorname" !== t.base.type || (t.base.parentIsSupSub = !0);
              var i, o = [Me(t.base, e)];
              if (t.sub && o.push(Me(t.sub, e)),
              t.sup && o.push(Me(t.sup, e)),
              a)
                  i = r ? "mover" : "munder";
              else if (t.sub)
                  if (t.sup) {
      ...
      te({
          ...
          mathmlBuilder: function(t, e) {
              var r, a = be(t.text, t.mode, e), n = we(t, e) || "normal";
              return r = "text" === t.mode ? new ve.MathNode("mtext",[a]) : /[0-9]/.test(t.text) ? new ve.MathNode("mn",[a]) : "\\prime" === t.text ? new ve.MathNode("mo",[a]) : new ve.MathNode("mi",[a]),
      ...
      var ya = {
              ...
              if ("string" == typeof r) {
                  ...
                  if (-1 !== r.indexOf("#"))
                      for (var n = r.replace(/##/g, ""); -1 !== n.indexOf("#" + (a + 1)); )
                          ++a;
                  for (var i = new la(r,this.settings), o = [], s = i.lex(); "EOF" !== s.text; )
                      o.push(s),
                      s = i.lex();
                  return o.reverse(),
                  {
        ...
        , Ma = function() {
          ...
          e.handleInfixNodes = function(t) {
              ...
              if (-1 !== r && e) {
                  var i, s, h = t.slice(0, r), l = t.slice(r + 1);
          ...
          e.parseSymbol = function() {
              ...
              Sa.hasOwnProperty(e[0]) && !j[this.mode][e[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + e[0] + '" used in math mode', t),
              e = Sa[e[0]] + e.substr(1));
              var i, s = sa.exec(e);
              ...
              j[this.mode][e]) {
                  ...
                  var h, l = j[this.mode][e].group, m = a.range(t);
